...
class _IncomePageState extends State<IncomePage> {
  ...
  void _loadData() {
    ...
    _database.child('income_transactions').onValue.listen((event) {
                    ...
                    if (titleController.text.isNotEmpty && amountController.text.isNotEmpty) {
                      ...
                      try {
                        ...
                        if (mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Income added: Rs ${amount.toStringAsFixed(2)}'), backgroundColor: Colors.green),
                          );
                        }
                      } catch (e) {
                        if (mounted) {
          ...
          child: Column(
            ...
            children: [
              ...
              isMobile
                  ? Column(
                children: [
                  _buildTotalCard('Cash Income', totalCash, Colors.green, Icons.money),
                  const SizedBox(height: 16),
                  _buildTotalCard('Online Income', totalOnline, Colors.blue, Icons.account_balance),
                ],
              )
                  : Row(
                children: [
                  Expanded(child: _buildTotalCard('Cash Income', totalCash, Colors.green, Icons.money)),
                  const SizedBox(width: 16),
                  Expanded(child: _buildTotalCard('Online Income', totalOnline, Colors.blue, Icons.account_balance)),
                ],
              ),
              const SizedBox(height: 24),

              // Total Income Card
              _buildTotalCard('Total Income', totalCash + totalOnline, AppColors.primaryOrange, Icons.trending_up),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          _searchController.text.isEmpty ? 'No income transactions yet' : 'No transactions found',
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(
                  transaction.paymentType == 'Cash' ? Icons.money : Icons.account_balance,
                  color: Colors.green,
                  size: 20,
                ),
              ),
